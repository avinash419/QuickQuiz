  ...
  return (
    <header className="glass border-b border-slate-200/60 sticky top-0 z-50 py-3 px-4 md:px-6 no-print">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="bg-white p-1 rounded-xl shadow-lg shadow-blue-500/10 group-hover:scale-110 transition-all duration-300 group-hover:rotate-3 overflow-hidden flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12">
            {logoUrl ? (
